...
namespace akademij.EF
{
    public partial class NRDAkademijaKaunasContext : DbContext
    {
        public NRDAkademijaKaunasContext(DbContextOptions<NRDAkademijaKaunasContext> options)
    : base(options)
        { }
